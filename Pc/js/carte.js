...
defaults : { 
	...
	this.txtStation = [
	['La gare d\'Auteuil-Boulogne est ouverte aux voyageurs le 2 mai 1854 comme terminus de la ligne d\'Auteuil, la reliant à la gare Saint-Lazare. <br />Elle reçoit les trains de la Petite-Ceinture à partir du 25 février 1867, jusqu\'au 20 décembre 1915. <br /> En 2007, les voies désaffectées au nord constituant la Petite Ceinture du 16e sont ouvertes aux piétons. <br /> Les quais de la gare furent détruits fin 2009 pour faire place à un projet immobilier mais ce dernier est bloqué. <br /> Le Bâtiment est actuellement occupé par un restaurant « le tendance »'],
	['La ligne ferme le 6 janvier 1985, lors des travaux de construction du RER C.<br /> Cette station faisait partie de la ligne des Batignolles à Auteuil, dite « ligne d’Auteuil » Comme ses consœurs de la ligne d’Auteuil, elle vit se juxtaposer au trafic habituel des trains circulaires de la Petite Ceinture, à partir du 25 février 1867, date de la mise en service de la Petite Ceinture Rive Gauche.<br /> Le 2 janvier 1925, la traction vapeur laisse la place à des rames automotrices électriques qui circuleront jusqu’au 6 janvier 1985, afin de laisser la place aux travaux de construction du RER C.<br /> Le Bâtiment est actuellement occupé par un restaurant'],
	['Elle fut construite à l’occasion de l’Exposition Universelle de 1878.<br /> L’architecture de cette gare est typique de la Compagnie des Chemins de Fer de l’Ouest pour les gares à cheval sur les voies.<br /> Aujourd’hui, cette gare est desservie par la ligne C du RER.<br /> Depuis 1931, un restaurant, Le Flandrin, occupe une partie de la gare.'],
	['Cette gare est située à proximité de la porte Dauphine au débouché de la très prestigieuse avenue du Bois de Boulogne (l’actuelle avenue Foch), qui relie cette porte à la place de l’Étoile. <br />Comme pour la gare Neuilly-Porte Maillot, le bâtiment voyageurs de cette gare, initialement identique à celui de la gare de l’Avenue Henri Martin, fut reconstruit dans un style prestigieux pour l’Exposition Universelle de 1900 par l’architecte Juste Lisch, également auteur des gares Saint-Lazare et des Invalides.<br />Vu son emplacement, cette gare fut utilisée pour accueillir des souverains et chefs d’État étrangers. Elle reçut ainsi le surnom de « la Gare des Souverains ». Elle joua ce rôle jusqu’en 1956, avec la visite à Paris du Maréchal Tito.'],
	...
	['La grande crue de la Seine de 1910 : Aussi surprenant que cela puisse paraître, puisque la place Péreire est éloignée de la Seine, la tranchée du boulevard Péreire fut envahie par l’eau pendant la crue de 1910. <br />D’ailleurs, ce fut la seule section de la Petite Ceinture à être atteinte par cette inondation. <br />Sans doute l’eau de la Seine est parvenue à se faufiler jusque-là par des réseaux souterrains.'],
	['Située au carrefour de la rue de Rome, du boulevard Péreire et de la rue Cardinet, cette gare fut reconstruite dans un style « Art Déco » dans les années Vingt, suite à la suppression du tunnel des Batignolles. <br />Le 2 janvier 1925, la traction vapeur laisse la place à des rames automotrices électriques qui circuleront jusqu’au 6 janvier 1985, afin de laisser la place aux travaux de construction du RER C.<br /> Elle est aujourd’hui encore en service, sous le nom de « Pont-Cardinet ».'],
	['Cette station fut mise en service le 16 novembre 1863, puis reconstruite pour le 16 mai 1889 lors de la suppression des passages à niveau sur la Petite Ceinture Rive Droite. <br />Elle était située à proximité du raccordement entre la Petite Ceinture et la ligne des Docks de Saint-Ouen.<br />Après la fermeture du service de voyageurs le dimanche 22 juillet 1934, le bâtiment voyageurs servit encore pour le service de messageries. <br />Puis, fin 1938, il fut transformé en un cinéma nommé le "Lumière". Ce cinéma fonctionna jusqu’à la fin des années Cinquante. <br />Depuis, le bâtiment est occupé par des commerces.'],
	['Cette station se trouve porte de Clignancourt, dans le 18e arrondissement, à deux pas du marché aux Puces de Saint-Ouen.<br /> Ce bâtiment existe toujours.Son architecture est caractéristique des gares situés à cheval sur les voies sur les sections Nord et Est de la Petite Ceinture.<br /> La même architecture fut utilisée pour les stations de porte de La Chapelle-Saint Denis (aujourd’hui démolie) et Charonne (préservée).'],
	['Ouverte d’abord de façon provisoire pour l’Exposition Universelles de 1867, elle fut réouverte pour celle de 1878 afin d’assurer les correspondances entre les trains de la Petite Ceinture desservant la gare du Champ-de-Mars avec ceux de la gare de l’Est.<br /> Puis, une fois l’Exposition terminée, elle resta ouverte.'],
	['Cette station fut ouverte le 26 avril 1869. Situé dans un quartier industriel déjà très urbanisé, elle fut établie en hauteur, comme la Petite ceinture à cet endroit, sur une structure porteuse en maçonnerie.<br />Comme le reste de la Petite Ceinture, la gare est fermée au trafic voyageur depuis le 1er avril 1934.<br />Le bâtiment voyageur est actuellement utilisé comme habitation.'],
	['C\'est l’actuelle salle de concert «  La Flèche d’or »<br />Cette station fut ouverte le 14 juillet 1862 afin de permettre notamment la circulation de trains ouvriers pour desservir les usines de ces quartiers en pleine phase d’industrialisation et d’urbanisation.<br />Les trains ouvriers étaient des trains circulant uniquement le matin et le soir pour permettre aux ouvriers d’aller travailler et de rentrer chez eux.À ces trains était associé un tarif préférentiel.<br />Avant de devenir un café-concert-restaurant, le bâtiment voyageurs fut utilisé après la fin du service voyageurs, comme beaucoup d’anciennes stations de la Petite Ceinture, comme bureau de messageries.'],
	['La gare de la rue d\'Avron ne figure pas dans les stations mises en service sur la Petite Ceinture dans les années 1850-1860. <br />Elle n\'est ouverte aux voyageurs que le 15 mai 1895, après un ensemble de travaux visant à supprimer les passages à niveau de la ligne sur la rive droite de la Seine.<br />Les murs de la gare sont construits en moellons enduits de crépis. L’étage, situé au niveau des quais, partage le style architectural des gares de voyageurs de la Grande Ceinture construites à la fin du XIXe siècle.<br />Les édifices n\'ont pas été réutilisés. Si le bâtiment sur la rue a bénéficié d\'un ravalement, les équipements du quai sont couverts de graffitis. Sur les voies, un quai subsiste.'],
	['Cette station, proche du Bois de Vincennes, fut ouverte le 26 avril 1869.<br />Le Président de la République de l\'époque, Sadi Carnot, visita les chantiers de suppression des passages à niveau sur la Petite Ceinture, le 14 décembre 1888, à hauteur de cette station.'],
	['Renommée gare du boulevard Masséna après l\'arrêt des circulations sur la Petite Ceinture.<br />Elle fut ouverte le 20 septembre 1840 lors de l\'ouverture de la première section de la ligne de Paris à Orléans, et fermée le 3 décembre 2000 lors de l\'ouverture de la gare de la Bibliothèque François-Mitterrand.<br />Cependant, les quais sont maintenus en l`\'état, au cas où une réouverture le justifierait. <br />La gare elle-même a été abondamment squattée et est, aujourd\'hui, en piteux état.<br />En 2009, la Ville de Paris a acheté la gare à la SNCF pour la convertir en un lieu dédié aux arts de la rue, du cirque et de la marionnette.'],
	['Ouverte en 1903 pour faire face au développement du trafic, notamment de charbon, dans les gares locales de marchandises de la Petite Ceinture, la gare des Gobelins fut desservie par le rail jusqu’en 1993.<br />Aujourd’hui, elle est toujours desservie...mais par camions et abritent des magasins de gros de produits asiatiques et le garage d’un loueur de voitures'],
	['Cette station est située près de la porte d’Orléans, dans le 14e arrondissement.<br />Elle fut ouverte aux voyageurs de la Petite Ceinture entre le 25 février 1867 et le 22 juillet 1934.<br />Après la fermeture de la gare au service des voyageurs le 22 juillet 1934, un service de messageries subsista dans une partie du bâtiment.La partie du bâtiment située le long de l’actuelle avenue du Général Leclerc fut rapidement occupée par un café nommé « Le Relais de Montrouge ».<br />Cette station fait l’objet depuis 2007 de la mobilisation du Conseil de Quartier Jean Moulin - Porte d’Orléans pour sa préservation et sa réhabilitation en lieu de vie de quartier.'],
	['Ce bâtiment fut construit vers 1866.<br />Cette station est située près de la porte de Vanves et le long des voies de la gare Montparnasse, dans le 14e arrondissement.<br />Elle permettait les correspondances entre la Petite Ceinture et le réseau banlieue partant de la gare Montparnasse.<br />Le bâtiment existe toujours. Les voies et les quais sont couverts par une dalle en béton.<br />Son architecture, caractérisée par une façade en brique roses et des merlonsblancs, est typique des gares de la banlieue Ouest de Paris et de Normandie. '],
	['La station Vaugirard-Ceinture fut mise en service le 25 février 1867, comme l’ensemble de la Petite Ceinture Rive Gauche.<br />Le bâtiment voyageurs existe toujours.Son architecture est identique à celle de la station Orléans-Ceinture. Elle est caractérisée par une façade en brique roses et des merlons blancs, typique des gares de la banlieue Ouest de Paris et de Normandie.<br />Cette station étant située près de la porte de Versailles, au début du XXe siècle, elle fut munie d’un couloir de correspondances avec la station de métro porte de Versailles.']
	 ];
